...
hr { margin: 2rem 0; border-bottom: 1px solid #E0E4E8; }
...
.Choice input { position: absolute; left: 0; top: 2px; }
...
/* Default list component .List is for a general purpose list of text .List--disc gives the list dots, for an unordered list .List--inline makes the list horizontal .List--50 makes list items 50% width .List__menu formats list item links like a product menu */
...
.Tabs__nav-item { color: #000000; margin: 0 1.25rem; padding: 0; font-size: 0.875rem; font-weight: 600; color: #677983; display: inline-block; position: relative; user-select: none; -webkit-transition: right 0.2s ease-out; -moz-transition: right 0.2s ease-out; transition: right 0.2s ease-out; }

.Tabs__nav-item:hover { cursor: pointer; color: #000000; }

.Tabs__nav-item a { display: block; color: #677983; padding: 0 0 1em 0; }

.Tabs__nav-item a:hover { text-decoration: none; color: #071c26; }

.Tabs__nav-item:after { content: ""; position: absolute; z-index: -1; left: 0; right: 100%; bottom: 0; background: #2BADE9; height: 2px; -webkit-transition: right 0.2s ease-out; -moz-transition: right 0.2s ease-out; transition: right 0.2s ease-out; }
...
.a-duration-1, .a-duration-xs { animation-duration: 0.3s !important; }
...
.a-easing-cb-scale-up { animation-timing-function: cubic-bezier(0.68, -0.55, 0.265, 1.55) !important; }
